...
export const metadata: Metadata = {
  ...
  description: "How KLEIO uses limited first-party product analytics during the founding artist beta.",
}
  ...
  return (
    <main className="min-h-dvh bg-[#FCFBFE] px-4 py-8 text-[#292631] sm:px-6">
      <article className="mx-auto max-w-3xl rounded-[30px] border border-[#E2DCF1] bg-white p-6 shadow-[0_24px_76px_rgba(82,64,130,0.07)] sm:p-9">
        ...
        <p className="mt-8 text-[0.68rem] font-semibold uppercase tracking-[0.17em] text-[#75639E]">Founding artist beta</p>
        ...
        <section className="mt-6 rounded-[22px] border border-[#E7E1F7] p-5" aria-labelledby="analytics-protection">
          ...
          <div className="mt-4 grid gap-4 text-sm leading-7 text-[#625C70]">
            <p>KLEIO does not sell artist behavioral data. The founding beta does not use advertising pixels or marketing-retargeting analytics.</p>
        ...
        <p className="mt-8 border-t border-[#E7E1F7] pt-5 text-xs leading-6 text-[#81788E]">This disclosure describes the founding artist-beta product analytics architecture. KLEIO should update this explanation before introducing any materially different measurement practice.</p>
      </article>
    </main>
  )
}
