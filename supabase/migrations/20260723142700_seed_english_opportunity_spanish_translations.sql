...
select
  opportunity_row.id, 'es', opportunity_row.source_language, translation.title, translation.summary,
...
join public.opportunities opportunity_row on opportunity_row.external_id = translation.external_id
