                  ...
                  <article key={claim.id} className="p-5 sm:p-6">
                    <div className="flex flex-col gap-4 lg:flex-row lg:items-start lg:justify-between">
                      <div className="min-w-0 flex-1">
                        ...
                        <div className={`mt-2 flex items-start gap-3 rounded-2xl border p-3.5 text-xs leading-5 ${presentation.className}`}><presentation.Icon className="mt-0.5 size-4 shrink-0" /><div><p className="font-semibold">{presentation.label}</p><p className="mt-0.5 opacity-90">{presentation.detail}</p></div></div>
                      </div>
