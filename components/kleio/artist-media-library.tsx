...
import { FileSearch, FileText, ImageIcon, Library, Loader2, Search, ShieldCheck, Sparkles, Trash2 } from "lucide-react"
  ...
  return (
    <main className="h-full overflow-y-auto bg-[#FCFBFE] px-4 py-5 sm:px-6 sm:py-6">
      <div className="mx-auto max-w-[1240px] space-y-5">
        <WorkspacePageHeader eyebrow="Artist workspace" title="KLEIO Media Library" description="Store each private source once, extract reviewable information, and reuse artist-approved records across the Creative Passport and future applications." />
        <section className="rounded-[26px] border border-[#E2DCF1] bg-[linear-gradient(135deg,#F8F5FF,#FFFFFF)] p-5 shadow-[0_18px_52px_rgba(82,64,130,0.06)]">
          <div className="flex flex-col gap-4 lg:flex-row lg:items-end lg:justify-between">
            <div className="max-w-2xl"><p className="text-[0.68rem] font-semibold uppercase tracking-[0.16em] text-[#75639E]">Private reusable sources</p><h2 className="mt-2 font-serif text-2xl font-semibold tracking-[-0.03em]">One file, structured knowledge you control</h2><p className="mt-2 text-sm leading-6 text-[#746E80]">Artwork, CVs, statements, proposals, and application materials remain private. KLEIO can analyze supported documents, preserve their evidence, and prepare updates that enter the Passport only after your approval.</p></div>
            <div className="flex flex-wrap gap-2">
              <QuickMediaImport
                context="creative_passport"
                label="Add private media"
