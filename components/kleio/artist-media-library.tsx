      ...
      <div className="mx-auto max-w-[1240px] space-y-5">
        ...
        <section className="rounded-[26px] border border-[#E2DCF1] bg-[linear-gradient(135deg,#F8F5FF,#FFFFFF)] p-5 shadow-[0_18px_52px_rgba(82,64,130,0.06)]">
          <div className="flex flex-col gap-4 lg:flex-row lg:items-end lg:justify-between">
            <div className="max-w-2xl"><p className="text-[0.68rem] font-semibold uppercase tracking-[0.16em] text-[#75639E]">Private reusable sources</p><h2 className="mt-2 font-serif text-2xl font-semibold tracking-[-0.03em]">One library for the work you bring into KLEIO</h2><p className="mt-2 text-sm leading-6 text-[#746E80]">The initial artist beta imports new work through Google Drive. Imported files remain private until you separately approve their use in a Portfolio, Creative Passport, profile, or application.</p></div>
            <Link href="/artist-dashboard/import/" className={primary}><UploadCloud className="size-4" />Import from Google Drive <ArrowRight className="size-4" /></Link>
          </div>
