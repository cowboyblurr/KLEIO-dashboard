...
export function ArtistMediaLibrary() {
  ...
  function openCollectionAnalysis() {
    if (selectedItems.length < 2) { setError("Select at least two supported private sources to use Media Assist together."); return }
    setError("")
