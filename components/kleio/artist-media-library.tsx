...
import { ArrowRight, FileSearch, FileText, ImageIcon, Library, Loader2, Search, ShieldCheck, Trash2, UploadCloud } from "lucide-react"
  ...
  return (
    <main className="h-full overflow-y-auto bg-[#FCFBFE] px-4 py-5 sm:px-6 sm:py-6">
      <div className="mx-auto max-w-[1240px] space-y-5">
        <WorkspacePageHeader eyebrow="Artist workspace" title="Media Library" description="Keep private images and documents in one place, then review and reuse artist-approved material across your Portfolio, Creative Passport, and applications." />
        <section className="rounded-[26px] border border-[#E2DCF1] bg-[linear-gradient(135deg,#F8F5FF,#FFFFFF)] p-5 shadow-[0_18px_52px_rgba(82,64,130,0.06)]">
          <div className="flex flex-col gap-4 lg:flex-row lg:items-end lg:justify-between">
            <div className="max-w-2xl"><p className="text-[0.68rem] font-semibold uppercase tracking-[0.16em] text-[#75639E]">Private reusable sources</p><h2 className="mt-2 font-serif text-2xl font-semibold tracking-[-0.03em]">One library for the work you bring into KLEIO</h2><p className="mt-2 text-sm leading-6 text-[#746E80]">Use Import work when KLEIO should help organize a group of artworks or source material. Use Quick upload for a single private image or document. Nothing becomes public without your approval.</p></div>
