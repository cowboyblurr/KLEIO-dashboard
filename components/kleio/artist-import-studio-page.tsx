        ...
        <header className="rounded-[28px] border border-[#E2DCF1] bg-white p-6 shadow-[0_22px_70px_rgba(82,64,130,0.07)] sm:p-8">
          <div className="flex flex-col gap-5 lg:flex-row lg:items-end lg:justify-between">
            <div className="max-w-3xl">
              ...
              <p className="mt-3 text-sm leading-7 text-[#746E80]">Choose artwork images from your device or Google Drive. KLEIO prepares editable records from available file information, then waits for your approval before adding any work to your private portfolio.</p>
            </div>
            <div className="grid gap-2 text-xs font-semibold text-[#625C70]">
              ...
              <span className="inline-flex items-center gap-2"><Images className="size-4 text-[#6A5896]" />Every artwork stays editable</span>
            </div>
          </div>
        </header>

        <ArtistImportStudio autoOpen />

        <section className="rounded-2xl border border-[#E7E1F7] bg-white p-5 text-sm leading-6 text-[#746E80]">
          <p><strong className="text-[#292631]">Prefer to continue manually?</strong> You can skip importing, build your Creative Passport field by field, or add works directly from the Portfolio page.</p>
