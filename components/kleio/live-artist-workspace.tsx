...
function LiveShell({ title, description, children }: { title: string; description: string; children: React.ReactNode }) {
  return <main className="h-full overflow-y-auto px-4 py-5 sm:px-6 sm:py-6"><div className="mx-auto max-w-[1180px] space-y-5"><WorkspacePageHeader eyebrow="Authenticated workspace" title={title} description={description} />{children}</div></main>
}
