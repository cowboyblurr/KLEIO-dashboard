...
import { FileCheck2, FileText, Images, Loader2, Sparkles } from "lucide-react"
      ...
      <div className="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between">
        <div className="flex min-w-0 items-center gap-2.5">
          ...
          <div className="min-w-0">
            <h2 id="passport-document-tools-title" className="text-sm font-semibold text-[#292631]">Build from documents</h2>
            <p className="truncate text-xs text-[#746E80]">Gemini places findings in the matching Passport fields for your approval.</p>
          </div>
        </div>
        <div className="flex flex-wrap gap-1.5">
          <Link href="/artist-dashboard/import/" className={action}><FileText className="size-3.5" />Upload PDF</Link>
