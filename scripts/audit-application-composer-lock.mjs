...
requireText(composer, /Open email to send/, "Email fallback must remain usable without claiming a connected provider send.")
requireText(composer, /prepareTrackedEmailClientHandoff/, "The canonical email action must create a tracked Review Room handoff rather than bypass recipient tracking.")
