...
requirePattern(documentUi, /Collapse results/, "Document analysis must expose a Collapse results control in its header.")
requirePattern(documentUi, /Expand results/, "A collapsed document analysis must expose an Expand results control.")
requirePattern(documentUi, /Clear analysis/, "Artists must have an obvious Clear analysis action.")
requirePattern(documentUi, /original PDF stays private/, "Clearing analysis must explicitly preserve the private PDF.")
requirePattern(documentUi, /Delete PDF/, "Artists must have an obvious Delete PDF action.")
