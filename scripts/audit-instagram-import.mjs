...
console.log("Instagram import audit passed: official read-only login, production gateway/core separation, immutable core provenance, database-clock one-time OAuth state, secure redirect relay, encrypted server-only tokens, database-enforced rights, resumable private drafts, explicit artist approval, and disconnect controls.")
