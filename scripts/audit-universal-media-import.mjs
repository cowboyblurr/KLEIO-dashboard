...
requireText(application, "Your application is saved while you add a work to Portfolio", "application preparation must explain the temporary Portfolio handoff truthfully")
