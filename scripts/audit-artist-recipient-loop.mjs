...
requirePattern(passportWorkspace, /completion\?\.percentage[\s\S]*Active applications/, "The compact interface must keep Passport completion and opportunity activity as separate values.")
