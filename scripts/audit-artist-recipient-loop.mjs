...
requirePattern(schema, /Internal workflow test\. This is not a real grant/, "The recipient snapshot must carry a persistent synthetic notice.")
...
requirePattern(recipientPage, /Email verified—not institution verified/, "Email verification must not be described as institution verification.")
...
requirePattern(alignment, /supported:\s*false/, "Weak thematic relationships must be representable as unsupported.")
