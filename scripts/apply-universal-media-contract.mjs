...
replaceRequired(
  ...
  'export type MediaKind = KleioMediaKind',
  "media kind alias",
)
...
replaceRequired(
  ...
  'description: "Choose artwork, media, or supporting material you already have. KLEIO prepares private, reusable records and waits for your approval.",\n    completionAction: "Add selected media",\n    allowedMimeTypes: KLEIO_GENERAL_UPLOAD_MIME_TYPES,\n    maxFileSizeBytes: 50 * 1024 * 1024,',
  "onboarding formats",
)
...
replaceRequired(
  ...
  'description: "Bring artwork, media, or a supporting file into your private Creative Passport workspace.",\n    completionAction: "Use selected media",\n    allowedMimeTypes: KLEIO_GENERAL_UPLOAD_MIME_TYPES,\n    maxFileSizeBytes: 50 * 1024 * 1024,',
  "passport formats",
)
...
replaceRequired(
  ...
  'description: "Start with the work itself. Review images, video, or audio, then add only the details that help you reuse it.",\n    completionAction: "Continue with selected media",\n    allowedMimeTypes: KLEIO_ARTWORK_MEDIA_MIME_TYPES,\n    maxFileSizeBytes: 50 * 1024 * 1024,',
  "portfolio formats",
)
...
replaceRequired(
  ...
  'allowedMimeTypes: KLEIO_ARTWORK_MEDIA_MIME_TYPES,\n    maxFileSizeBytes: 50 * 1024 * 1024,\n    maxSelectionCount: 10,\n    allowMultiple: true,\n    availableSources: ["kleio_library", "device", "google_drive"],\n    requireMetadataReview: true,',
  "application portfolio formats",
)

replaceRequired(
  'allowedMimeTypes: ["application/pdf", "image/jpeg", "image/png", "image/webp"],\n    maxFileSizeBytes: 20 * 1024 * 1024,\n    maxSelectionCount: 10,\n    allowMultiple: true,\n    availableSources: ["kleio_library", "device", "google_drive"],',
  'allowedMimeTypes: KLEIO_GENERAL_UPLOAD_MIME_TYPES,\n    maxFileSizeBytes: 50 * 1024 * 1024,\n    maxSelectionCount: 10,\n    allowMultiple: true,\n    availableSources: ["kleio_library", "device", "google_drive"],',
  "opportunity requirement formats",
)

replaceRequired(
  'allowedMimeTypes: ["image/jpeg", "image/png", "image/webp", "application/pdf"],\n    maxFileSizeBytes: 20 * 1024 * 1024,\n    maxSelectionCount: 30,\n    allowMultiple: true,\n    availableSources: ["kleio_library"],',
  'allowedMimeTypes: KLEIO_GENERAL_UPLOAD_MIME_TYPES,\n    maxFileSizeBytes: 50 * 1024 * 1024,\n    maxSelectionCount: 30,\n    allowMultiple: true,\n    availableSources: ["kleio_library", "device"],',
  "media library upload formats",
)
...
if (!source.includes("KLEIO_GENERAL_UPLOAD_MIME_TYPES") || !source.includes("device")) throw new Error("Universal media contract verification failed")
